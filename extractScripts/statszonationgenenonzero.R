...
# Import data
dfnormal <- read_csv(paste0(mge_directory,"Normal_MGEZ123_nonzero.csv"))
dfAH <- read_csv(paste0(mge_directory,"AH_MGEZ123_nonzero.csv"))
...
write_csv(t_test_results, paste0(stats_directory, "ttestoncentralportalgenesmean_nonzero.csv"))
